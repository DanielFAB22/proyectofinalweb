...
<html>
  ...
  <div class="row align-items-center">
      ...
      <div id="carouselExampleCaptions" class="carousel slide">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../../assets/lespaulp90/lespaul(1).jpg" class="d-block w-100" alt="Les paul p90">
          </div>
          <div class="carousel-item">
            <img src="../../assets/lespaulp90/lespaul(2).jpg" class="d-block w-100" alt="Les paul p90">
          </div>
        </div>
    ...
    <div class="col-md-5 descripcion">
      <h1>GIBSON® LES PAUL (P90)</h1>
      <h2>ESPECIFICACIONES:</h2>
      <p>MATERIAL CUERPO: CAOBA CON TAPA ARCE</p>
      <p>MATERIAL DIAPASÓN: PALO ROSA</p>
      <p>MATERIAL CUELLO: CAOBA</p>
      <p>CANTIDAD TRASTES: 22 TRASTES MEDIUM JUMBO</p>
      <p>MICROFONOS: ALNICO V P90 GIBSON®</p>
      <p>10´682.500</p>
