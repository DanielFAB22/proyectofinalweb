...
<html>
    ...
    <body>
        ...
        <nav class="menu">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="gibson.jsp">GIBSON</a></li>
                    <li><a class="dropdown-item" href="#">SCHECTER</a></li>
        ...
        <div class="container justify-content-center text-center">
            <img src="../../../assets/catalogos/guitarras/schecter/schecter.png" class="d-block mx-auto p-3 w-50 h-25" alt="logo gibson">
  ...
  <div class="card">
      <img src="../../../assets/catalogos/guitarras/schecter/avengerstandard.png" class="card-img-top" alt="AVENGER STANDARD">
    <div class="card-body">
      <h5 class="card-title">AVENGER STANDARD</h5>
      <p class="card-text">1´600.000</p>
      <button type="button" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-basket me-2" viewBox="0 0 16 16">
  <path d="M5.757 1.071a.5.5 0 0 1 .172.686L3.383 6h9.234L10.07 1.757a.5.5 0 1 1 .858-.514L13.783 6H15a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1v4.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 13.5V9a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h1.217L5.07 1.243a.5.5 0 0 1 .686-.172zM2 9v4.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V9zM1 7v1h14V7zm3 3a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 4 10m2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 6 10m2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 8 10m2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3a.5.5 0 0 1 .5-.5m2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3a.5.5 0 0 1 .5-.5"/>
  </svg>AÑADIR AL CARRITO</button>
    </div>
  </div>
  <div class="card">
    <img src="../../../assets/catalogos/guitarras/schecter/damien6.png" class="card-img-top" alt="DAMIEN 6">
    <div class="card-body">
      <h5 class="card-title">DAMIEN 6</h5>
  ...
  <div class="card">
    <img src="../../../assets/catalogos/guitarras/schecter/e-1custom.png" class="card-img-top" alt="E-1 CUSTOM">
    <div class="card-body">
      <h5 class="card-title">E-1 CUSTOM</h5>
      <p class="card-text">4´190.000</p>
      <button type="button" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-basket me-2" viewBox="0 0 16 16">
  <path d="M5.757 1.071a.5.5 0 0 1 .172.686L3.383 6h9.234L10.07 1.757a.5.5 0 1 1 .858-.514L13.783 6H15a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1v4.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 13.5V9a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h1.217L5.07 1.243a.5.5 0 0 1 .686-.172zM2 9v4.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V9zM1 7v1h14V7zm3 3a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 4 10m2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 6 10m2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3A.5.5 0 0 1 8 10m2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3a.5.5 0 0 1 .5-.5m2 0a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-1 0v-3a.5.5 0 0 1 .5-.5"/>
  </svg>AÑADIR AL CARRITO</button>
    </div>
