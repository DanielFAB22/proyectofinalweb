...
<html>
  ...
  <div class="row align-items-center">
      ...
      <div id="carouselExampleCaptions" class="carousel slide">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../../assets/fenderprecisionbass/fenderprecisionbass(1).jpg" class="d-block w-100" alt="FENDER PRECISION BASS">
          </div>
          <div class="carousel-item">
            <img src="../../assets/fenderprecisionbass/fenderprecisionbass(2).jpg" class="d-block w-100" alt="FENDER PRECISION BASS">
          </div>
        </div>
    ...
    <div class="col-md-5 descripcion">
      <h1>FENDER PRECISION BASS NEGRO</h1>
      <h2>ESPECIFICACIONES:</h2>
      <p>MATERIAL CUERPO: ALDER</p>
      <p>MATERIAL DIAPASÓN: PALO ROSA</p>
      <p>MATERIAL CUELLO: MAPLE</p>
      <p>CANTIDAD TRASTES: MEDIUM JUMBO</p>
      <p>3´790.000</p>
