...
<html>
  ...
  <div class="row align-items-center">
      ...
      <div id="carouselExampleCaptions" class="carousel slide">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../../assets/omen6/omen6(1).jpg" class="d-block w-100" alt="Schecter omen 6">
          </div>
          <div class="carousel-item">
            <img src="../../assets/omen6/omen6(2).jpg" class="d-block w-100" alt="Schecter omen 6">
          </div>
        </div>
    ...
    <div class="col-md-5 descripcion">
      <h1>SCHECTER OMEN 6</h1>
      <h2>ESPECIFICACIONES:</h2>
      <p>MATERIAL CUERPO: BASSWOOD</p>
      <p>MATERIAL DIAPASÓN: PALO ROSA</p>
      <p>MATERIAL CUELLO: MAPLE</p>
      <p>CANTIDAD TRASTES: 24 X-JUMBO</p>
      <p>1´790.000</p>
